    ...
    <div class="row mt-5">
        <div class="col-lg-6">
            <form action="{{route('todos.create')}}" method="post">
                <h4>Dodaj punkt do listy</h4>
                @csrf
                <div class="form-group">
                    <input name="id" type="hidden" class="form-control" value="{{ $todo->id }}">
                    <input placeholder="Tekst" name="text" type="text" class="form-control" value="{{ $todo->text }}" >
                </div>
            ...
            <table class="table">
                ...
                @foreach($todos as $todo)
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-sm btn-primary" href="{{route('todos.showid',[$todo->id])}}" >Edytuj</a>
                        </td>
                    </tr>
                @endforeach
            </table>
